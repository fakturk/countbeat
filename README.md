...
`${GOPATH}/src/github.com/fakturk/countbeat`
...
```
git remote set-url origin https://github.com/fakturk/countbeat
...
```
mkdir -p ${GOPATH}/src/github.com/fakturk/countbeat
git clone https://github.com/fakturk/countbeat ${GOPATH}/src/github.com/fakturk/countbeat
```
